...
> 前置：后端接口返回的数据是这样的：
> 
> ![img](https://img-blog.csdnimg.cn/direct/19b51f85ba8349f5b61f22749839da75.png)
> 
> ①首先在store中取出后端返回的数据A=res.data，在这里打印输出是正常的
>
> ![img](https://img-blog.csdnimg.cn/direct/5b0f36c01a9e4d16b02453be7222a27d.png)
>
> ②然后在vue页面上再取出A.data也就是res.data.data，以及其它几个字段即res.data.XXX，在这里打印输出是空白的
>
> ![img](https://img-blog.csdnimg.cn/direct/0eea1d7532d74d78931f8330b61671f2.png)
>
> ③结果在图表页中取出的一直是undefined（读取属性不存在），但是第一次加载不出来，再刷新一下却又能拿到数据了。
>
> ![img](https://img-blog.csdnimg.cn/direct/e76369cd6cf14547820b630984ad6690.png)
>
> **最后的解决方案：**
>
> 在定义data/computed的时候，就先对A的所有属性进行枚举，需要用到后端data里的哪一层就枚举几层，于是就没问题了！
>
> ![img](https://img-blog.csdnimg.cn/direct/a777917d2f5e46279e5263f4b0eec860.png)
>
...
![img](https://img-blog.csdnimg.cn/direct/26a405ad0e954ee68e173cd6ab05d30c.png)
...
![img](https://img-blog.csdnimg.cn/direct/3729ede93261472f87b5ae0b0d1f1833.png)
...
>
> ![img](https://img-blog.csdnimg.cn/direct/5ec9db43fdb243969df320afb22d4790.png)
### Dep
...
>
> ![img](https://img-blog.csdnimg.cn/direct/2f3c90b590dc46bb98b83b9ea3eb1fa2.png)
...
![img](https://img-blog.csdnimg.cn/direct/ab35cf674eaa4450959829e8f6556208.png)
![img](https://img-blog.csdnimg.cn/direct/51808a624d7844798afd34699901331c.png)